	...
	async function findUser(e) {
		...
		await axiosPrivate
			...
			.then((res) => {
				...
				if (res.data.foundUser.length === 0 && preSearchState.length !== 0)
					setCustomers(preSearchState);
			})
			.catch((err) => {
				console.log(err);
				redirect(err);
		...
		return (
			<div id='table'>
				<div id='tableHeadContainer'>
					...
					<img
						src={
							'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7d/Refresh_icon.svg/1200px-Refresh_icon.svg.png'
						}
						id='refreshButton'
