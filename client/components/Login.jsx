...
const Login = () => {
	...
	function loginAttempt() {
		...
		axiosPublic
			...
			.catch((err) => {
				setSnackbarMessage(
					'Error while trying to login, please wait and try again'
				);
				setSnackbarSeverity('error');
				openSnackbar();
				setFetching(false);
	...
	return (
		<div id='loginContainer'>
			...
			>
				<img
					src={
						'https://uploads-ssl.webflow.com/6093315d74407812c0b3270c/61574b48f3de49d46e8ab2ff_NOTS%20%26%20Crest%20(BlackFont)-04.svg'
					}
					id='crestLogo'
				/>
				<div id='subheadingContainer'>
					<h2 id='loginHeading'>Login</h2>
					<h5 id='loginSubheading'>
						Please provide your NOTS admin email and password, below
					</h5>
				</div>
				<TextField
					required
